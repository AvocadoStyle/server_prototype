...
private:
	...
	int __request_op_handle(int OP);

	void __message_handle_main();
	void __message_handle_header();
	void __message_handle_payload();
	void __message_handle_userid();
	void __message_handle_version();
	void __message_handle_op();
	void __message_handle_name_len_and_file_name();
	void __message_handle_size_and_payload();
};
